...
- [ ] **Phase 6: Master TODO Roadmap Execution (Refer to `TODO.md`)**
  ...
  - [x] **Task 5**: Ultra-Minimalist Search Overlay.
  - [x] **Task 13**: Advanced Dynamic Link & Date Rule Visual Editor (Unimib Orari & Esami).
  - [ ] **Task 15**: In-Column Section Separators & Sub-Headers (Divider Lines / Titles).
  - [x] **Task 16**: Column & Navbar Geometry, Spacing & Color Customization (Redesigned top header to Floating Glass Island Dock with detached glassmorphism capsules).
