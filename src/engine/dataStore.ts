...
const MIGRATION_V4 = 'migrated_v4_restore_unimib_scripts';
...
export const ORARI_SCRIPT = `(function() {
  ...
  var now = new Date();
  var today = parseDate(now);
  var anno = now.getMonth() >= 8 ? now.getFullYear() : now.getFullYear() - 1;
  var url = "https://gestioneorari.didattica.unimib.it/PortaleStudentiUnimib/index.php?view=easycourse&form-type=corso&include=corso&txtcurr=1+-+PERCORSO+COMUNE&anno=" + anno + "&scuola=&corso=F1802Q&anno2%5B%5D=GGG%7C1&visualizzazione_orario=cal&date=" + today + "&periodo_didattico=&_lang=it&list=&week_grid_type=-1&ar_codes_=EC508261%7CEC512923%7CEC508282%7CEC512924%7CEC509735&ar_select_=true%7Ctrue%7Ctrue%7Ctrue%7Cfalse&col_cells=0&empty_box=0&only_grid=0&highlighted_date=0&all_events=0#";
 ...
 * favicons/tooltips/edit-forms fallback.
 */
export const UNIMIB_ORARI_BASE_URL =
  'https://gestioneorari.didattica.unimib.it/PortaleStudentiUnimib/index.php?view=easycourse&corso=F1802Q';
export const UNIMIB_ESAMI_BASE_URL =
  'https://gestioneorari.didattica.unimib.it/PortaleStudentiUnimib/index.php?view=easytest&esami_cdl=F1802Q';
...
export const DEFAULT_CONFIG: StartpageConfig = {
  commands: [
    ...
    },
    {
      id: 'tiktok',
      title: 'tiktok',
      url: 'https://www.tiktok.com/it-IT',
      aliases: ['tt', 'tiktok'],
      category: 'Social',
      searchPath: '/search?q={}',
    },
    ...
    },
    {
      ...
      aliases: ['x', 'twitter'],
      category: 'Social',
      searchPath: '/search?q={}&src=typed_query',
    },
    {
      id: 'reddit',
      title: 'Reddit',
    ...
    // Fun
    {
      ...
      category: 'Fun',
      searchPath: '/results?search_query={}',
    },
    {
      id: 'twitch',
      title: 'Twitch',
    ...
    },
    {
      ...
      aliases: ['p', 'prime'],
      category: 'Fun',
      searchPath: '/region/eu/search/ref=atv_nb_sug?ie=UTF8&phrase={}',
    },
    {
      id: 'spotify',
      title: 'Spotify',
    ...
    },
    {
      id: 'simkl',
      title: 'simkl',
      url: 'https://simkl.com/8617331/dashboard/',
      aliases: ['tv', 'simkl'],
      category: 'Fun',
    },
    ...
    },
    {
      id: 'sudokude',
      title: 'Sudoku de',
      url: 'https://logic-masters.de/Raetselportal/index.php',
      aliases: ['sude', 'sudokude'],
      category: 'Fun',
    },
    {
      id: 'sudokucoach',
    ...
    },
    {
      ...
      aliases: ['arxiv'],
      category: 'Reading & News',
      searchPath: '/search/?query={}&searchtype=all&source=header',
    },
    {
      id: 'jair',
      title: 'Jair',
      url: 'https://www.jair.org/index.php/jair/index',
      aliases: ['jair'],
      category: 'Reading & News',
    },
    {
      id: 'quantamagazine',
      title: 'Quantamagazine',
      url: 'https://www.quantamagazine.org/',
      aliases: ['quanta', 'quantamagazine'],
      category: 'Reading & News',
    },
    {
      id: 'scientificamerican',
      title: 'ScentificAmerica',
      url: 'https://www.scientificamerican.com/#',
      aliases: ['scientificamerican'],
      category: 'Reading & News',
    },
    {
      id: 'theguardian',
    ...
    },
    {
      ...
      aliases: ['wd', 'schooldrive'],
      category: 'School',
      searchPath: '/drive/search?q={}',
    },
    {
      id: 'segreteria',
      title: 'Segreteria',
      url: 'https://s3w.si.unimib.it/auth/studente/HomePageStudente.do',
      aliases: ['segreteria'],
      category: 'School',
    },
    {
      ...
      aliases: ['esami', 'unimib_esami'],
      category: 'School',
      dynamicUrlRule: 'unimib_esami',
      isScript: true,
      scriptContent: ESAMI_SCRIPT,
    },
    {
      id: 'unimib_orari',
      title: 'Orari',
      url: 'javascript:updateOrari()',
      aliases: ['orari', 'unimib_orari'],
      category: 'School',
      dynamicUrlRule: 'unimib_orari',
      isScript: true,
      scriptContent: ORARI_SCRIPT,
    },
    {
      id: 'appunti',
      title: 'Appunti',
      url: 'https://mega.nz/folder/4bUhDBzA#EkBRNE5HKmguMammZohU6g/folder/9b8wlKQa',
      aliases: ['app', 'appunti'],
      category: 'School',
    },
    {
      id: 'aml',
      title: 'AML',
      url: 'https://elearning.unimib.it/enrol/index.php?id=68868',
      aliases: ['metodiscie', 'aml'],
      category: 'School',
    },
    {
      id: 'ai_course',
      title: 'AI',
      url: 'https://elearning.unimib.it/enrol/index.php?id=68862',
      aliases: ['AI', 'ai_course'],
      category: 'School',
    },
    {
      id: 'crv',
    ...
    },
    {
      id: 'stepfun',
      title: 'Stepfun',
      url: 'https://stepfun.ai/chats/new',
      aliases: ['stepfun'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    ...
    },
    {
      id: 'liquid',
      title: 'Liquid',
      url: 'https://playground.liquid.ai/chat',
      aliases: ['liquid'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    ...
    },
    {
      id: 'byteplus',
      title: 'BytePlus',
      url: 'https://www.byteplus.com/en/ai-playground/chat',
      aliases: ['byteplus'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    {
      id: 'sarvam',
      title: 'Sarvam',
      url: 'https://dashboard.sarvam.ai/chat',
      aliases: ['sarvam'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    {
      id: 'jamba',
      title: 'Jamba',
      url: 'https://studio.ai21.com/v2/workspaces',
      aliases: ['jamba'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    ...
    },
    {
      id: 'motiftech',
      title: 'Motif Tech',
      url: 'https://chat.motiftech.io/chat',
      aliases: ['motiftech'],
      category: 'AI & LLMs',
      searchPath: '?q={}',
    },
    ...
    },
    {
      ...
      aliases: ['leo', 'leonardo'],
      category: 'ImGen',
    },
    {
      id: 'stablediffusion',
      title: 'Stable Diff',
      url: 'https://stablediffusionweb.com/app/image-generator',
      aliases: ['sd', 'stablediffusion'],
      category: 'ImGen',
    },
    {
      id: 'getimg',
      title: 'getimg',
      url: 'https://getimg.ai/home',
      aliases: ['getimg'],
      category: 'ImGen',
    },
    {
      id: 'quiver',
      title: 'Quiver',
      url: 'https://app.quiver.ai/',
      aliases: ['quieverai', 'quiver'],
      category: 'ImGen',
    },
    {
      id: 'krea',
 ...
 */
const isWebNavigableUrl = (url: string): boolean =>
  /^https?:\/\//i.test(url.trim()) || url.trim().startsWith('/');
...
const neutralizeImportedScript = (item: LinkItem): LinkItem | null => {
  if (isBuiltinUnimibScriptItem(item)) {
    const isOrari =
      item.dynamicUrlRule === 'unimib_orari' ||
      item.id === 'unimib_orari' ||
      item.id === 'orari' ||
      item.title === 'Orari';
    return {
      ...item,
      isScript: true,
      url: isOrari ? 'javascript:updateOrari()' : 'javascript:updateEsami()',
      scriptContent: isOrari ? ORARI_SCRIPT : ESAMI_SCRIPT,
      dynamicUrlRule: isOrari ? 'unimib_orari' : 'unimib_esami',
    };
  }

  const hasScriptFlag = item.isScript === true;
  const hasScriptContent =
    typeof item.scriptContent === 'string' && item.scriptContent.trim().length > 0;
  ...
  if (!isWebNavigableUrl(item.url)) {
    console.warn(
      `[DataStore] Import: discarded scripted link "${item.title}" (no navigable url left after stripping javascript:)`,
    );
    return null;
  }
  ...
  console.warn(
    `[DataStore] Import: neutralized scripted link "${item.title}" (script machinery stripped, url kept)`,
  );
  return cleaned;
};
...
const normalizeUnimibDynamicItem = (item: LinkItem): boolean => {
  const isOrari =
    ...
    item.title === 'Orari';
  const isEsami =
    item.dynamicUrlRule === 'unimib_esami' ||
    item.id === 'unimib_esami' ||
    item.id === 'esami' ||
    item.title === 'Esami';
...
/**
 * Migration v4: Restores built-in Unimib links (Orari & Esami) to first-party
 * JavaScript bookmarklet scripts with dynamic academic year and date calculation.
 * User customizations (title/icon/category/aliases) are preserved.
 */
const normalizeRestoreUnimibScripts = (item: LinkItem): boolean => {
  const isOrari =
    item.dynamicUrlRule === 'unimib_orari' ||
    item.id === 'unimib_orari' ||
    item.id === 'orari' ||
  ...
  let dirty = false;
  const rule = isOrari ? 'unimib_orari' : 'unimib_esami';
  const scriptContent = isOrari ? ORARI_SCRIPT : ESAMI_SCRIPT;
  const url = isOrari ? 'javascript:updateOrari()' : 'javascript:updateEsami()';
  ...
  if (item.scriptContent !== scriptContent) {
 ...
 *   exact default title) into their first-party script bookmarklet form.
...
const normalizeLegacyItem = (item: LinkItem): boolean => {
  ...
  if (normalizeRestoreUnimibScripts(item)) dirty = true;
  return dirty;
};
...
export class DataStore {
  ...
  public load(): void {
    try {
      ...
      console.warn(
        '[DataStore] Failed to load stored configuration, falling back to defaults:',
        err,
      );
    }
    this.runMigrations();
  ...
  private runMigrations(): void {
    ...
    const migrations: Record<string, (item: LinkItem) => boolean> = {
      ...
      // v4 (first-party): restores built-in Unimib links to first-party scripts.
      [MIGRATION_V4]: normalizeRestoreUnimibScripts,
    };
  ...
  public moveLink(linkId: string, targetCategoryId: string, targetIndex?: number): void {
    ...
    if (
      ...
      targetIndex >= 0 &&
      targetIndex < targetCategoryLinks.length
    ) {
  ...
  public importJsonDetailed(jsonString: string): ImportResult {
    ...
    if (parsed && typeof parsed === 'object' && !Array.isArray(parsed)) {
      ...
      if (Array.isArray(rawCommands)) {
        ...
        if (rawCommands.length > 0 && sanitized.length === 0) {
          console.warn(
            '[DataStore] Failed to import configuration: no entry has the required fields (id/title/url)',
          );
        ...
        if (isWrappedShape && Array.isArray(container.categoryOrder)) {
          this.categoryOrder = container.categoryOrder.filter(
    ...
    console.warn(
      '[DataStore] Failed to import configuration: unrecognized backup shape (missing "commands" array)',
    );
