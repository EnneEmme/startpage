 ...
 * Includes complete migration of legacy links from old homepage.
 */
...
export const DEFAULT_CONFIG: StartpageConfig = {
  ...
  commands: [
    ...
    { id: 'cohere', title: 'Cohere', url: 'https://dashboard.cohere.com/playground/chat', aliases: ['cohere'], category: 'AI & LLMs' },
    ...
    { id: 'elevenlabs', title: 'ElevenLabs', url: 'https://elevenlabs.io/app/home', aliases: ['elevenlabs'], category: 'ImGen & Media' }
  ]
};
