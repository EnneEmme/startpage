...
describe('Production Build', () => {
  it.skipIf(!fs.existsSync(distPath))('should generate a single index.html file within size budget', () => {
  ...
  it.skipIf(!fs.existsSync(distPath))('should not reference the Google Fonts provider (B4 regression)', () => {
